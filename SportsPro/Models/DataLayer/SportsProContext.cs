...
namespace SportsPro.Models
{
    public class SportsProContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerProduct>().HasKey(ba => new { ba.CustomerId, ba.ProductId });

            // BookAuthor: set foreign keys 
            modelBuilder.Entity<CustomerProduct>().HasOne(ba => ba.Customer)
                .WithMany(b => b.CustomerProducts)
                .HasForeignKey(ba => ba.CustomerId);
            modelBuilder.Entity<CustomerProduct>().HasOne(ba => ba.Product)
